...
public class SpriteFlash : MonoBehaviour
{
    ...
    public void StartFlash(float flashDuration, Color flashColour, int numberOfFlashes)
    {
        StartCoroutine(FlashCoroutine(flashDuration, flashColour, numberOfFlashes));
    }
